...
|---|---|---|---|
| M0 Unblock + scaffold | in_progress | both | done: M0.1 M0.2 M0.3 M0.5 M0.8 M0.6 · in flight: M0.7, M0.4 · blocked: M0.9 (Graph key) · town = botanica · human: fill `.env` |
...
In progress: M0.7 mock server (T3, spawned 23:15), M0.4 register botanica.eth (T2)
