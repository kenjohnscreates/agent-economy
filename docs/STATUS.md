...
|---|---|---|---|
| M0 Unblock + scaffold | in_progress | both | done: M0.1 M0.2 M0.3 M0.5 M0.8 · in flight: M0.6 M0.9 · next: M0.7 · M0.4 waits on town name · human: fill `.env` |
...
In progress: M0.6 shared zod contract (T2), M0.9 Signal C subgraphs (T3) — spawned 23:00
